    ...
    <div class="flex">
        ...
        <aside class="w-64 bg-emerald-900 text-white min-h-screen fixed left-0 top-0">
            ...
            <nav class="p-6 space-y-3">
                <a href="<?= base_path('admin/dashboard') ?>" class="block px-4 py-3 rounded-lg bg-emerald-800 text-white font-medium hover:bg-emerald-700 transition">
                    📊 Dashboard
                </a>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-emerald-800 mt-2">Rp <?= number_format($totalRevenue, 0, ',', '.') ?></p>
                    </div>
                    <div class="w-14 h-14 bg-emerald-50 rounded-lg flex items-center justify-center text-2xl">
                        💰
                    </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-slate-200">
            ...
            <?php else: ?>
                ...
                <div class="p-6 border-t border-slate-200 bg-emerald-50">
                    <a href="<?= base_path('admin/orders') ?>" class="text-emerald-800 hover:text-emerald-900 font-medium">
                        Lihat Semua Pesanan →
                    </a>
                </div>
            </div>
